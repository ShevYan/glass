...
?>
      <?php if ($this->_foreach['no']['iteration'] < 9): ?>
...
"
 ...
 <?php echo htmlspecialchars($this->_var['cat']['name']); ?>
  <img src="themes/ecmoban_aizhigu/images/biao8.gif">
 </a>
</div>
...
<dd  id=DisSub2_<?php echo $this->_foreach['no']['iteration']; ?> style="display:none"> 
 ...
 <a class="over_2" href="<?php echo $this->_var['cat']['url']; ?>"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a>  

<div class="clearfix">
<?php $_from = $this->_var['cat']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child');if (count($_from)):
    foreach ($_from AS $this->_var['child']):
?>
<a class="over_3" href="<?php echo $this->_var['child']['url']; ?>"><?php echo htmlspecialchars($this->_var['child']['name']); ?></a>
