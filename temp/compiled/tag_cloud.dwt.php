...
?>
          ...
          <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>&amp;uid=<?php echo $this->_var['tag']['user_id']; ?>" title="<?php echo $this->_var['lang']['drop']; ?>"> <img src="themes/ecmoban_aizhigu/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /> </a>&nbsp;&nbsp;
          <?php endif; ?>
          </span>
